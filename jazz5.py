...
def get_pattern5(jazz_scale, ascend):
...
def get_pattern5_chord_measure(jazz_scale):
...
def get_score():
    ...
    for key in sideman.keys_in_order():
        ...
        treble_pattern.append( get_pattern5(jazz_scale, key % 2 == 0) )
        chords.append( get_pattern5_chord_measure(jazz_scale) )
